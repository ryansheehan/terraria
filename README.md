...
**[UPDATE]** I know a lot of people are excited for Terraria v1.4 Journey's End!  The current latest tag on dockerhub is hand built for the latest pre-release of TShock, which supports v1.4.0.2.  Please be patient, as this is not a full release.  The source code here is still on the 1.3.5.2 release.  This project will update after the TShock team posts their full release.
